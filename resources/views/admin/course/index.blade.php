    ...
    <main>
        ...
        <div class="card rounded-md mx-auto max-w-7xl py-6 sm:px-6 lg:px-8" style="background-color: #a4b6c4">
            ...
            <div class="card-body">
                ...
                <!-- Search Bar -->
                <form class="my-5 d-flex justify-content-center" method="GET" action="{{ route('courses.index') }}"
                    accept-charset="UTF-8" role="search">
                    <div class="grid grid-cols-12 gap-1 relative mb-3" data-te-input-wrapper-init>
                        <div class="col-span-12 md:col-span-4">
                        </div>
                        <div class="col-span-12 md:col-span-3">
                            <input class="peer block min-h-[auto] mb-4 w-full rounded border-0 bg-light px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-800 dark:placeholder:text-zinc-350 dark:peer-focus:text-primary [&:not([data-te-input-placeholder-active])]:placeholder:opacity-100 form-control" maxlength="50" type="text" name="search"
                    ...
                    <table class="table-auto my-5">
                        <thead class="">
                            <tr>
                                ...
                                <th class="columns-7xl">Course Description</th>
                                <th class="columns-2xl action-column">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            @if (count($courses) > 0)
