...
@section('metaDescription', 'List out all of the Courses that are available.')
        ...
        <div class="card rounded-md mx-auto max-w-7xl py-6 sm:px-6 lg:px-8" style="background-color: #a4b6c4">
            <div align="right" class="card-header">
                ...
                <button onclick="create_course_modal.showModal()"
                    class="button_primary button_primary:hover px-6">
            ...
            <div class="card-body">
                ...
                <!-- Search Bar -->
                <form class="flex justify-center" method="GET" action="{{ route('courses.index') }}" accept-charset="UTF-8"
                    role="search">
